...
static const uint8_t PROINVESTCOIN_BLOCK_VERSION = 0xA0;
static const uint8_t PROINVESTCOIN_TXN_VERSION = 0xA0;
static const uint8_t MAX_PROINVESTCOIN_TXN_VERSION = 0xBF;
...
inline bool IsProInvestCoinTxVersion(int nVersion)
{
    return (nVersion & 0xFF) >= PROINVESTCOIN_TXN_VERSION;
}
...
inline void UnserializeTransaction(TxType& tx, Stream& s) {
    ...
    if (bv >= PROINVESTCOIN_TXN_VERSION) {
        tx.nVersion = bv;
...
inline void SerializeTransaction(const TxType& tx, Stream& s) {
    ...
    if (IsProInvestCoinTxVersion(tx.nVersion)) {
...
public:
    ...
    static const int32_t CURRENT_PROINVESTCOIN_VERSION=0xA0;
    ...
    static const int32_t MAX_STANDARD_PROINVESTCOIN_VERSION=0xA0;
...
public:
    ...
    bool IsProInvestCoinVersion() const {
        return IsProInvestCoinTxVersion(nVersion);
    }
    ...
    {
        return IsProInvestCoinTxVersion(nVersion) ? vpout.size() : vout.size();
    }
