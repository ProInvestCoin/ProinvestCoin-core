                     ...
                     std::vector<valtype>& ret, txnouttype& whichTypeRet, SigVersion sigversion, SignatureData& sigdata)
{
    ...
    case TX_WITNESS_V0_KEYHASH:
        if (creator.IsProInvestCoinVersion())
            return false;
...
bool ProduceSignature(const SigningProvider& provider, const BaseSignatureCreator& creator, const CScript& fromPubKey, SignatureData& sigdata)
{
    ...
    bool fIsP2SH = creator.IsProInvestCoinVersion()
...
public:
    ...
    bool is_proinvestcoin_tx = false;
    bool IsProInvestCoinVersion() const override { return is_proinvestcoin_tx; }
};
...
SignatureData DataFromTransaction(const CMutableTransaction& tx, unsigned int nIn, const std::vector<uint8_t> &amount, const CScript &scriptPubKey)
{
    ...
    extractor_checker.is_proinvestcoin_tx = tx.IsProInvestCoinVersion();
...
bool SignSignature(const SigningProvider &provider, const CTransaction& txFrom, CMutableTransaction& txTo, unsigned int nIn, int nHashType)
{
    ...
    if (txTo.IsProInvestCoinVersion()) {
...
class DummySignatureCheckerProInvestCoin : public DummySignatureChecker
{
// IsProInvestCoinVersion() must return true to skip stack evaluation
public:
    DummySignatureCheckerProInvestCoin() : DummySignatureChecker() {}
    bool IsProInvestCoinVersion() const override { return true; }
};
const DummySignatureCheckerProInvestCoin DUMMY_CHECKER_PROINVESTCOIN;

class DummySignatureCreatorProInvestCoin : public DummySignatureCreator {
public:
    DummySignatureCreatorProInvestCoin() : DummySignatureCreator(33, 32) {}
    const BaseSignatureChecker& Checker() const override { return DUMMY_CHECKER_PROINVESTCOIN; }
    bool IsProInvestCoinVersion() const override { return true; }
};
...
const BaseSignatureCreator& DUMMY_SIGNATURE_CREATOR_PROINVESTCOIN = DummySignatureCreatorProInvestCoin();
