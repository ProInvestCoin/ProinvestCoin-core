...
#ifndef PROINVESTCOIN_SCRIPT_PROINVESTCOINCONSENSUS_H
#define PROINVESTCOIN_SCRIPT_PROINVESTCOINCONSENSUS_H
...
#include <config/bitcoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBPROINVESTCOINCONSENSUS)
...
#endif // PROINVESTCOIN_SCRIPT_PROINVESTCOINCONSENSUS_H
