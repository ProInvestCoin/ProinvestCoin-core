...
extern bool fProInvestCoinMode;
...
BasicTestingSetup::BasicTestingSetup(const std::string& chainName, bool fProInvestCoinModeIn)
...
{
    fProInvestCoinMode = fProInvestCoinModeIn;
    ...
    ResetParams(chainName, fProInvestCoinMode);
...
TestingSetup::TestingSetup(const std::string& chainName, bool fProInvestCoinModeIn) : BasicTestingSetup(chainName, fProInvestCoinModeIn)
{
    SetDataDir("tempdir");
