...
BOOST_FIXTURE_TEST_SUITE(proinvestcoinchain_tests, ProInvestCoinBasicTestingSetup)
...
BOOST_AUTO_TEST_CASE(signature_test)
{
    ...
    CMutableTransaction txn;
    txn.nVersion = PROINVESTCOIN_TXN_VERSION;
    txn.nLockTime = 0;
    ...
    txn2.nVersion = PROINVESTCOIN_TXN_VERSION;
...
BOOST_AUTO_TEST_CASE(proinvestcoinchain_test)
{
    SeedInsecureRand();
    CBasicKeyStore keystore;
    ...
    CBlock blk;
    blk.nVersion = PROINVESTCOIN_BLOCK_VERSION;
    blk.nTime = 1487406900;
    ...
    txnSpend.nVersion = PROINVESTCOIN_BLOCK_VERSION;
}
...
BOOST_AUTO_TEST_CASE(mixed_input_types)
{
    CMutableTransaction txn;
    txn.nVersion = PROINVESTCOIN_TXN_VERSION;
    BOOST_CHECK(txn.IsProInvestCoinVersion());
    ...
    txnPrev.nVersion = PROINVESTCOIN_TXN_VERSION;
    BOOST_CHECK(txnPrev.IsProInvestCoinVersion());
