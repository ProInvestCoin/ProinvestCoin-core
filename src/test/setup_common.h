...
struct BasicTestingSetup {
    ...
    explicit BasicTestingSetup(const std::string& chainName = CBaseChainParams::MAIN, bool fProInvestCoinModeIn = false);
    ~BasicTestingSetup();
...
struct TestingSetup : public BasicTestingSetup {
    ...
    explicit TestingSetup(const std::string& chainName = CBaseChainParams::MAIN, bool fProInvestCoinModeIn = false);
    ~TestingSetup();
};
...
struct ProInvestCoinBasicTestingSetup : public BasicTestingSetup {
    ProInvestCoinBasicTestingSetup() : BasicTestingSetup(CBaseChainParams::MAIN, true) {}
};
