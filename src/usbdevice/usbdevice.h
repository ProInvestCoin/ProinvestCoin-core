...
#ifndef PROINVESTCOIN_USBDEVICE_USBDEVICE_H
#define PROINVESTCOIN_USBDEVICE_USBDEVICE_H
...
public:
    ...
    bool IsProInvestCoinVersion() const override { return txTo && txTo->IsProInvestCoinVersion(); }
...
#endif // PROINVESTCOIN_USBDEVICE_USBDEVICE_H
