...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendpictoblind", 1, "amount" },
    { "sendpictoblind", 4, "subtractfeefromamount" },
    { "sendpictoanon", 1, "amount" },
    { "sendpictoanon", 4, "subtractfeefromamount" },

    { "sendblindtopic", 1, "amount" },
    { "sendblindtopic", 4, "subtractfeefromamount" },
    ...
    { "sendanontopic", 1, "amount" },
    { "sendanontopic", 4, "subtractfeefromamount" },
    { "sendanontopic", 6, "ringsize" },
    { "sendanontopic", 7, "inputs_per_sig" },
    ...
    { "createrawpictransaction", 0, "inputs" },
    { "createrawpictransaction", 1, "outputs" },
    { "createrawpictransaction", 2, "locktime" },
    { "createrawpictransaction", 3, "replaceable" },
