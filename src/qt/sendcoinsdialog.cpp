...
void SendCoinsDialog::clear()
{
    ...
    ui->cbxTypeFrom->setCurrentIndex(ui->cbxTypeFrom->findText("Pic"));
    ui->cbxTypeTo->setCurrentIndex(ui->cbxTypeTo->findText("Pic"));
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid ProInvestCoin address"));
        }
        else // Valid address
        {
