Contributing to ProInvestCoin Core
============================

The ProInvestCoin project operates an open contributor model where anyone is
...
Most communication about ProInvestCoin development happens on [#proinvestcoin-dev:matrix.org](https://riot.im/app/#/room/#proinvestcoin-dev:matrix.org), in the ProInvestCoin Open Development channel on Riot. The easiest way to participate on Riot is
...
The following applies to code changes to the ProInvestCoin project..

Whether a pull request is merged into ProInvestCoin Core rests with the project merge
...
Patches that change ProInvestCoin consensus rules are considerably more involved than
...
[//]: # (Where a patch set proposes to change the ProInvestCoin consensus, it must have been
...
The project leader is the release manager for each ProInvestCoin Core release.
