...
class ZMQTest(ProInvestCoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that proinvestcoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("proinvestcoind has not been built with zmq enabled.")
