...
from test_framework.test_proinvestcoin import isclose


class WalletProInvestCoinWatchOnlyTest(ProInvestCoinTestFramework):
...
if __name__ == '__main__':
    WalletProInvestCoinWatchOnlyTest().main()
