#!/usr/bin/env python3
# Copyright (c) 2017-2018 The ProInvestCoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

from test_framework.test_proinvestcoin import ProInvestCoinTestFramework, isclose
from test_framework.util import connect_nodes_bi
from test_framework.authproxy import JSONRPCException


class BlindTest(ProInvestCoinTestFramework):
    ...
    def run_test(self):
        ...
        txnHash = nodes[0].sendpictoblind(sxAddrTo1_1, 3.4, '', '', False, 'node0 -> node1 p->b')
        ...
        txnHash4 = nodes[1].sendblindtopic(sxAddrTo2_1, 0.5, '', '', False, 'node1 -> node2 b->p')
        ...
        txnHash5 = nodes[0].sendpictoblind(sxAddrTo2_3, 0.5, '', '', False, 'node0 -> node2 p->b')
        ...
        ro = nodes[1].sendtypeto('blind', 'pic', outputs, 'comment_to', 'comment_from', 4, 64, True)
        ...
        nodes[1].sendtypeto('blind', 'pic', outputs)
        ...
        nodes[0].sendtypeto('pic', 'blind', outputs)
        ...
        self.log.info('Test sending all blind to pic')
